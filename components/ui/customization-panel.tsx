...
import { Settings, Users, Star, Music, Image as ImageIcon, Calendar } from "lucide-react"
...
const colorPalette = [
  "#C7A14B", "#B08B3C", "#8B6C2A", "#D4B76B",
  "#A38235", "#E5C57C", "#967730", "#F5E6D3"
]
        ...
        <Card className="h-full bg-gradient-to-br from-zinc-900 to-black border-2 border-amber-900/30 overflow-hidden">
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(100vh-16rem)]">
            <Accordion type="single" collapsible className="space-y-3">
              ...
              {/* Theme & Layout */}
              <AccordionItem value="theme" className="border-2 border-amber-900/20 rounded-xl overflow-hidden bg-black/20">
                <AccordionTrigger className="px-4 py-4 hover:no-underline hover:bg-amber-500/5 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-amber-100">Theme & Layout</span>
                  </div>
                </AccordionTrigger>
              ...
              {/* Couple Info */}
              <AccordionItem value="couple" className="border-2 border-amber-900/20 rounded-xl overflow-hidden bg-black/20">
                <AccordionTrigger className="px-4 py-4 hover:no-underline hover:bg-amber-500/5 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-amber-500/10 rounded-lg">
                      <Users className="w-4 h-4 text-amber-500" strokeWidth={1.5} />
                    </div>
                    <span className="font-medium text-amber-100">Couple Info</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-4 pb-4">
                  <div className="space-y-3 pt-2">
              ...
              <AccordionItem value="select-theme" className="border-2 border-amber-900/20 rounded-xl overflow-hidden bg-black/20">
                <AccordionTrigger className="px-4 py-4 hover:no-underline hover:bg-amber-500/5 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-amber-500/10 rounded-lg">
                      <ImageIcon className="w-4 h-4 text-amber-500" strokeWidth={1.5} />
                    </div>
                    <span className="font-medium text-amber-100">Select Theme</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-4 pb-4">
                  <div className="space-y-2 pt-2">
                    {["Jawa Elegan", "Modern Sakura", "Sunda Klasik"].map((theme) => (
                      <button
                        key={theme}
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-amber-100">{theme}</span>
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              {/* Event Timeline */}
              <AccordionItem value="timeline" className="border-2 border-amber-900/20 rounded-xl overflow-hidden bg-black/20">
                <AccordionTrigger className="px-4 py-4 hover:no-underline hover:bg-amber-500/5 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-amber-500/10 rounded-lg">
                      <Calendar className="w-4 h-4 text-amber-500" strokeWidth={1.5} />
                    </div>
                    <span className="font-medium text-amber-100">Event Timeline</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-4 pb-4">
                  <div className="space-y-3 pt-2">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-black/20 border-2 border-amber-900/20">
                <div className="flex items-center gap-3">
                  <ImageIcon className="w-4 h-4 text-amber-500" strokeWidth={1.5} />
                  <span className="text-sm text-amber-100">Background Pattern</span>
                </div>
                <Switch checked={backgroundPattern} onCheckedChange={setBackgroundPattern} />
              </div>
            ...
            <div className="mt-6 space-y-3">
              <Button 
                className="w-full h-12 bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 hover:from-amber-500 hover:via-amber-400 hover:to-amber-500 text-black font-semibold shadow-lg shadow-amber-500/25 border-0"
              >
                Save & Publish
              </Button>
              <Button 
