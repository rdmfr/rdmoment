...
// Impor Button dan Link jika kamu menggunakannya nanti
...
  return (
    <section id="themes" className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
...
              onClick={() => setSelectedCategory(cat)}
              /* INI BAGIAN YANG DIPERBAIKI. 
                Huruf 'g' yang nyasar di baris berikutnya sudah dihapus.
              */
