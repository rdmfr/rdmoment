    ...
    <section id="themes" className="py-20 px-4 sm:px-6 lg:px-8 bg-zinc-950">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="font-serif text-4xl sm:text-5xl font-normal text-amber-100 mb-4 tracking-wide">
            Jelajahi Pilihan Tema Kami
          </h2>
          <p className="text-lg text-amber-100/60">
            Pilih dari desain yang terinspirasi budaya atau ciptakan gayamu
            sendiri
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filtered.map((theme) => (
            <Link
              ...
              className="group cursor-pointer block transition-shadow hover:shadow-lg hover:shadow-amber-500/10"
            >
              ...
              <h3 className="font-semibold text-lg text-amber-100 mb-2 group-hover:text-amber-400 transition-colors">
                {theme.name}
              </h3>
