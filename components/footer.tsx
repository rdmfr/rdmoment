      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-12 gap-12 mb-12">
          ...
          <div className="md:col-span-4">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-0 group mb-4"
            >
            ...
            <p className="text-amber-100/60 font-light leading-relaxed mb-6 max-w-sm">
              Merayakan kisah cinta di seluruh dunia dengan undangan digital
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link
                    href="#themes"
                    className="text-amber-100/60 hover:text-amber-400 transition-colors font-light"
                  >
                    Tema
                  </Link>
                </li>
        ...
        <div className="pt-8 border-t border-amber-900/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-amber-100/50 font-light">
              <span>Made with</span>
              <Heart
                className="w-4 h-4 text-amber-500 fill-amber-500 animate-pulse"
                aria-hidden="true"
              />
