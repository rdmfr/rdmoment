    ...
    <aside className="customization-panel">
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="bg-background/40 px-3 py-2 rounded-md">
            Theme: <strong className="ml-2">Classic Gold</strong>
          </div>
        </div>
        ...
        <div>
          <button className="w-full py-3 rounded-md btn-gold font-semibold">
            Save & Publish
          </button>
        </div>
      </div>
